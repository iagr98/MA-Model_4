...
if __name__ == "__main__":
    ...
    with open('simulation_results_parallel_evaluation_detail_event.csv', mode='w', newline='') as file:
    ...
    df_results.to_csv('simulation_results_parallel_evaluation_detail_event_1.csv', index=False)
